...
import { PageWrapper, Navbar, Section, Header, HeaderContainer, Subheader, Button, ButtonContainer } from "./Elements";
	...
	return (
		<>
			...
			<PageWrapper>
				...
				<Section row>
					<HeaderContainer>
						<Header>Teacherspace - let's do it together!</Header>
						<Subheader>Sharing the knowledge with your students have never been easier!</Subheader>
					</HeaderContainer>
					<img
				...
				<Section row>
					<HeaderContainer>
						<Header>What is our mission?</Header>
						<Subheader>
							We are trying to push teaching further into the future. Students are the most important people out there, as they will
							build future world, so we are trying to organize their work as efficiently as it is possible. COVID-19 outbreak has shown,
							that the educational sector is far behind in terms of innovation and had to overcome a lot of problems to achieve it's
							normal flow of work. That's where we come in!
						</Subheader>
					</HeaderContainer>
				</Section>
				<Section column>
					<Header>Why us?</Header>
					<Subheader>Here is a list of amenities we are currently providing, and, what's more, sneak peek of upcomming features.</Subheader>
					<FeaturesList />
				</Section>
			</PageWrapper>
		</>
